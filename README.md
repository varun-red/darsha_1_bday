...
- **Details cards** — when, where (with map link) and good-to-know notes.
...
- **Event settings** — every word on the site (names, dates, venue, schedule, milestones, FAQ, message templates) is editable live.
